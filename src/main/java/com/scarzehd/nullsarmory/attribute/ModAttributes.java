...
public class ModAttributes {
    ...
    public static final RegistryEntry<EntityAttribute> SHIELDS_UNDERFLOW = registerEntityAttribute("generic.shields_underflow", new CustomEntityAttribute("attribute.nulls_armory.shields_underflow", 0), true);
