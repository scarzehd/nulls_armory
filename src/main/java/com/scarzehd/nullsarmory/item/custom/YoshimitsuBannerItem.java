...
public class YoshimitsuBannerItem extends Item {
    public YoshimitsuBannerItem() {
        super(new Item.Settings().attributeModifiers(AttributeModifiersComponent.builder()
                .add(EntityAttributes.GENERIC_ATTACK_DAMAGE, new EntityAttributeModifier(BASE_ATTACK_DAMAGE_MODIFIER_ID, 5f, EntityAttributeModifier.Operation.ADD_VALUE), AttributeModifierSlot.MAINHAND)
