...
public class ModItems {
    ...
    public static final Item SCOUT_CHESTPLATE = registerItem("scout_chestplate", new ArmorItem(ModArmorMaterials.SCOUT, ArmorItem.Type.CHESTPLATE, new Item.Settings().maxCount(1).attributeModifiers(ShieldsUtilities.createShieldAttributeModifierComponent(3, -5, 0, 2, "scout_chestplate", AttributeModifierSlot.CHEST))));
    public static final Item SCOUT_LEGGINGS = registerItem("scout_leggings", new ArmorItem(ModArmorMaterials.SCOUT, ArmorItem.Type.LEGGINGS, new Item.Settings().maxCount(1).attributeModifiers(ShieldsUtilities.createShieldAttributeModifierComponent(3, -5, 0, 2, "scout_leggings", AttributeModifierSlot.LEGS))));
