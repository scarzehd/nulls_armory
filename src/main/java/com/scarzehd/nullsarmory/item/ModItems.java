...
public class ModItems {
    ...
    public static final Item STARMAN_BOOTS = registerItem("starman_boots", new ArmorItem(ModArmorMaterials.STARMAN, ArmorItem.Type.BOOTS, new Item.Settings().maxCount(1).maxDamage(1000).attributeModifiers(ShieldsUtilities.createShieldAttributeModifierComponent(3, 0, 0, 0, "starman_boots", AttributeModifierSlot.FEET))));

    public static final Item TRENCH_HELMET = registerItem("trench_helmet", new ArmorItem(ModArmorMaterials.TRENCH, ArmorItem.Type.HELMET, new Item.Settings().maxCount(1).maxDamage(1000).attributeModifiers(ShieldsUtilities.createShieldAttributeModifierComponent(8, 5, 1, 2, "trench_helmet", AttributeModifierSlot.HEAD))));
    public static final Item TRENCH_CHESTPLATE = registerItem("trench_chestplate", new ArmorItem(ModArmorMaterials.TRENCH, ArmorItem.Type.CHESTPLATE, new Item.Settings().maxCount(1).maxDamage(1000).attributeModifiers(ShieldsUtilities.createShieldAttributeModifierComponent(10, 5, 2, 3, "trench_chestplate", AttributeModifierSlot.CHEST))));
    public static final Item TRENCH_LEGGINGS = registerItem("trench_leggings", new ArmorItem(ModArmorMaterials.TRENCH, ArmorItem.Type.LEGGINGS, new Item.Settings().maxCount(1).maxDamage(1000).attributeModifiers(ShieldsUtilities.createShieldAttributeModifierComponent(8, 5, 1, 3, "trench_leggings", AttributeModifierSlot.LEGS))));
    public static final Item TRENCH_BOOTS = registerItem("trench_boots", new ArmorItem(ModArmorMaterials.TRENCH, ArmorItem.Type.BOOTS, new Item.Settings().maxCount(1).maxDamage(1000).attributeModifiers(ShieldsUtilities.createShieldAttributeModifierComponent(6, 5, 1, 2, "trench_boots", AttributeModifierSlot.FEET))));

    public static final Item SCOUT_HELMET = registerItem("scout_helmet", new ArmorItem(ModArmorMaterials.SCOUT, ArmorItem.Type.HELMET, new Item.Settings().maxCount(1).maxDamage(1000).attributeModifiers(ShieldsUtilities.createShieldAttributeModifierComponent(2, -5, -1, 1, "scout_helmet", AttributeModifierSlot.HEAD))));
    public static final Item SCOUT_CHESTPLATE = registerItem("scout_chestplate", new ArmorItem(ModArmorMaterials.SCOUT, ArmorItem.Type.CHESTPLATE, new Item.Settings().maxCount(1).maxDamage(1000).attributeModifiers(ShieldsUtilities.createShieldAttributeModifierComponent(2, -5, 0, 2, "scout_chestplate", AttributeModifierSlot.CHEST))));
    public static final Item SCOUT_LEGGINGS = registerItem("scout_leggings", new ArmorItem(ModArmorMaterials.SCOUT, ArmorItem.Type.LEGGINGS, new Item.Settings().maxCount(1).maxDamage(1000).attributeModifiers(ShieldsUtilities.createShieldAttributeModifierComponent(2, -5, 0, 2, "scout_leggings", AttributeModifierSlot.LEGS))));
    public static final Item SCOUT_BOOTS = registerItem("scout_boots", new ArmorItem(ModArmorMaterials.SCOUT, ArmorItem.Type.BOOTS, new Item.Settings().maxCount(1).maxDamage(1000).attributeModifiers(ShieldsUtilities.createShieldAttributeModifierComponent(2, -5, -1, 1, "scout_boots", AttributeModifierSlot.FEET))));
